...
// Returns true for CJK characters that allow line breaks on either side without
// hyphenation. Covers CJK Unified Ideographs, Hiragana, Katakana, Hangul
// Syllables, CJK punctuation, and fullwidth forms — the ranges where word
// boundaries are implicit per character.
...
// Returns true for Unicode combining diacritical marks that should not advance
// the cursor.
