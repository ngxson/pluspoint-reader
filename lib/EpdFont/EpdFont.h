...
class EpdFont {
  void getTextBounds(const char *string, int startX, int startY, int *minX,
...
public:
  ...
  /// Returns the kerning adjustment (4.4 fixed-point in pixels) between two
  /// codepoints. Returns 0 if no kerning data exists for the pair.
